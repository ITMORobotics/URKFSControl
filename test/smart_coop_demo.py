...
coop_state1.build_from_SE3(SE3(0.15, -0.5, 0.5) @ SE3.Rx(np.pi, 'rad'), SE3(0.0, -0.3, 0.0) @ SE3.Rz(0.0, 'rad'))

coop_state2 = coop_robot.CoopCartState()
coop_state2.build_from_SE3(SE3(-0.15, -0.5, 0.35) @ SE3.Rx(np.pi, 'rad'), SE3(0.0, -0.3, 0.0) @ SE3.Rz(0.0, 'rad'))
...
def main():
    ...
    time.sleep(2.0)
    coop_system.p2p_cartmove_avoid(copy.deepcopy(coop_state2), 10.0, False)
